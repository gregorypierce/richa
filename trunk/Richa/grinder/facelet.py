...
headers1= \
  ( NVPair('Accept', 'text/css,*/*;q=0.1'),
    NVPair('Referer', 'http://localhost:8080/richa/formsample.xhtml'), )
...
request101 = Test(101, 'GET formsample.xhtml').wrap(request101)
...
class TestRunner:
  ...
  def page1(self):
    ...
    result = request101.GET('/richa/formsample.xhtml')
